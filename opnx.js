...
function openTab(evt, tabName) {
    ...
    if (tabName == "Headings") {
                ...
                if (headings) {
                    ...
                    for (var j = 0; j < headings.length; j++) {
                        if (headings[j].textContent !== "") {
                            ...
                            linname.className = "headName"
                            linname.innerText = " " + headings[j].innerText;
        ...
        for (i = 0; i < glinks.length; i++) {
            if (glinks[i].className !== "atb-hide-if-empty" || glinks[i].classList) {
